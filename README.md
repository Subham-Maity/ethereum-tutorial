# Welcome to BlockChain A-Z eBook Vol 2
...
## 1. Why we need Ethereum Acc ?

### 1. If we want to transact ether or receive ether then we need an account that is ethereum account like bank account. 

### 2. There are 2 types of ethereum account one is externally owned account(EOA) and second is contract account (CA)
...
* ### Whenever we create a wallet we can create EOA.It can be a Metamask Wallet,My Ether Wallet or Any Wallet.
* ### Also, we can see our ether balance in that wallet 
...
```javascript
The Ethereum Virtual Machine is the software platform 
that developers can use to create decentralized applications (DApps) 
on Ethereum. This virtual machine is where 
all Ethereum accounts and smart contracts live.
```
## For More Info about EVM Click [Here](https://ethereum.org/en/developers/docs/evm/)
## What is Gas Click [Here](https://www.youtube.com/watch?v=AJvzNICwcwc&t=34s&ab_channel=Ethos) For Video
## Details About GAS and [FEES](https://ethereum.org/en/developers/docs/gas/)
